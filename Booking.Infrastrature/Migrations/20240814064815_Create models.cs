    ...
    public partial class Createmodels : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResidenceOwners", x => new { x.UserId, x.ResidenceId, x.Id });
                    table.CheckConstraint("CK_OwnershipPercentage", "[OwnershipPercentage] >= 0 AND [OwnershipPercentage] <= 100");
                    table.CheckConstraint("CK_PurchaseAndSaleDates", "[SaleDate] > [PurchaseDate]");
                    table.ForeignKey(
                        name: "FK_ResidenceOwners_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ResidenceOwners_Residences_ResidenceId",
                        column: x => x.ResidenceId,
                        principalTable: "Residences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Percentage", "[Percentage] >= 0 AND [Percentage] <= 100");
                    table.CheckConstraint("CK_StartAndEndDate", "[EndDateUtc] > [StartDateUtc]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomAmenities", x => new { x.RoomId, x.AmenityId, x.Id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RoomId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ResidenceBookingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ResidenceBookingUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ResidenceBookingResidenceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomBookings", x => new { x.RoomId, x.ResidenceBookingId, x.Id });
                    table.ForeignKey(
                        name: "FK_RoomBookings_ResidenceBookings_ResidenceBookingUserId_ResidenceBookingResidenceId_ResidenceBookingId",
                        columns: x => new { x.ResidenceBookingUserId, x.ResidenceBookingResidenceId, x.ResidenceBookingId },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResidenceOwners_ResidenceId",
