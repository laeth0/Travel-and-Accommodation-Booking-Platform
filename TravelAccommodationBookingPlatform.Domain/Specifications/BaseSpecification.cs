...
using TravelAccommodationBookingPlatform.Domain.Utils;

namespace TravelAccommodationBookingPlatform.Domain.Specifications;
public class BaseSpecification<T> : ISpecification<T> where T : class
{
    ...
    public BaseSpecification<T> AddOrderByDescending(Expression<Func<T, object>> orderByDescExpression)
    {
