        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivationCodeExpiresAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Coordinates_Latitude = table.Column<double>(type: "float(18)", precision: 18, scale: 15, nullable: false),
                    Coordinates_Longitude = table.Column<double>(type: "float(18)", precision: 18, scale: 15, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelImageAssociations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HotelImageAssociations_Hotel_HotelId",
                        column: x => x.HotelId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StarRate = table.Column<int>(type: "int", nullable: false),
                    HotelId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MaxNumberOfGuests_Adults = table.Column<int>(type: "int", nullable: false),
                    MaxNumberOfGuests_Children = table.Column<int>(type: "int", nullable: false),
                    PricePerNight_Value = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Checking_CheckInDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Checking_CheckOutDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    NumberOfGuests_Adults = table.Column<int>(type: "int", nullable: false),
                    NumberOfGuests_Children = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomImageAssociations", x => x.Id);
                    table.ForeignKey(
